...
function Projects() {
  ...
  return (
    <section 
    ref={ref} 
    className='bg-dark-purple-blue flex flex-col items-center gap-8 relative'>
...
{/* <p>public repositories <span className='text-clear-orangeish'>{githubStats?.public_repos}</span></p>
          <p>followers  <span className='text-clear-orangeish'>{githubStats?.followers}</span></p>
          <p>following <span className='text-clear-orangeish'>{githubStats?.following}</span></p> */}

// {!isVisible ? 'hidden self-end p-2}`
