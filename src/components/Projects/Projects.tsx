    ...
    className='bg-purple-blue'>
      <div className='flex flex-col  h-full'>
          ...
          <Carousel>
            {
              ...
              .map((p) => (
                ...
                src={p.image} 
                alt="" 
                className='size-56 md:size-80 2xl:w-[34rem] object-contain rounded-xl lg:rounded-3xl'
                />
              ))
            }
          </Carousel>
        ...
        target='_blank'>
          ...
          weight='light' 
          size={"2rem"} 
          className='group-hover:text-orangeish transition-colors duration-500 delay-[150ms]'
          />
        </a>
      </div>
    </section>
